...
<link href="/TeamB/css/A02/entry-ja-style.css" rel="stylesheet"
	type="text/css">
<title>トップページ</title>
</head>
		...
		<form action="EntrySave" method="post">
			<table class="table table-bordered">
				<tbody>
					...
					<tr>
						<th>学籍番号</th>
						<td><input type="number" class="form-control no-spin" max="9999999"></td>
					</tr>
							...
							<div class="row">
								...
								<div class="mb-3 col">
									<select class="form-select" id="exampleFormSelect1">
										...
										<option value="A03">機械CAD設計科</option>
										<option value="A03">国際ビジネス科</option>
										<option value="A03">ゲームクリエーター科</option>
										<option value="A03">ゲームエンジニア科</option>
										<option value="A03">CGクリエーター</option>
										<option value="A03">Webクリエーター</option>
										<option value="A03">デジタルデザイン科</option>
										<option value="A03">デジタルミュージック科</option>
										<option value="A03">映像放送科</option>
										<option value="A03">音響制作科</option>
										<option value="A03">モバイルアプリケーション科</option>
										<option value="A03">情報システム科</option>
										<option value="A03">AIシステムエンジニア科</option>
										<option value="A03">ネットワークシステム科</option>
										<option value="A03">サイバーセキュリティ科</option>
										<option value="A03">AIテクノロジーエンジニア科</option>
										<option value="A03">高度ITエンジニア科</option>
										<option value="A03">総合情報ビジネス科</option>
									</select>
								</div>
							</div>
						</td>
